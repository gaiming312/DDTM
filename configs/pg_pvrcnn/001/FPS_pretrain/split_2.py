...
work_dir = outputs_dir+'{}/{}_encoder_pvrcnn/split_{}'.format(pretrained_split_frac, sampled,split_num)
pretrained = dict(
detector_3d="outputs/pg_pvrcnn/{}/pretrain_pvrcnn/split_{}/epoch_40.pth".format(pretrained_split_frac, split_num)
)

load_from = None
resume_from = None
encoder_checkpoints = \
    "/home/lab/YYF/PointCloud/DetMatch/tools/pretrain_encoder/checkpoints/{}/encoder_{}_{}.pth".format(sampled,split_frac,split_num)
batch_size = 2
num_unlabeled_samples = 1

data_root = '/home/lab/YYF/data/kitti/'
...
model = dict(
    ...
    model_cfg=dict(
        ...
        detector_3d=dict(
            ...
            dataset_fields=dict(
                class_names=['Pedestrian', 'Cyclist', 'Car'],
                point_feature_encoder=dict(num_point_features=4), # point_feature
                point_cloud_range=[0, -40, -3, 70.4, 40, 1],
                voxel_size=[0.05, 0.05, 0.1],
    ...
    ssl_cfg=dict(
        ...
        unlabeled=[
            ...
            # add feature
            dict(
                type='maskInputPoints',
                point_key = 'stu.points',
                in_bboxes_key='tea.3d_bboxes_nms_stu_aug',
                out_points_key = 'stu.pos_points',
                out_points_feat_key = 'stu.pos_mask',
            ),
            dict(
                type = "ReweightModule",
                # stu_point_key = 'stu.points',
                pos_point_key = 'stu.pos_points',
                out_key = 'stu.reweight_feat',
                checkpoints = encoder_checkpoints,
            ),
            dict(
